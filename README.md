...
<!--     <p>Choose how many frames to be processed.Less framess more accurate, more frames more speed(default 3)</p> -->
    ...
    <br>
    <p>Once processing is complete, you will receive three download links: the annotated video, detailed results (predictions from each frame), and a summary showing the most frequently detected animals.</p>
...
<div align="center" style="padding: 10px; margin-top: 30px; margin-bottom: 20px;">
    ...
    <br>
      ...
      <p>Select the number of frames to be processed (same as in the first endpoint).</p>
    <hr style="border-top: 1px solid #ccc; margin-top: 20px; margin-bottom: 20px;">
